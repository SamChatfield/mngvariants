In this folder you will find tabular format files (.txt), variant calling files (.vcf), reference fasta (sequences.fa), reference annotations (genes.gff), regions of no coverage (.bed) and bam/bam index files (.bam, .bai).
